  ...
  return (
    <div className="flex flex-col gap-12">
      ...
      <section className="card bg-base-200 border border-base-300 p-8 md:p-12 text-center gap-4">
        ...
        <Link to="/register" className="btn btn-primary self-center mt-2">{t('b2b.ctaRegister')}</Link>
      </section>
      ...
      <section className="card bg-base-200 border border-base-300 p-8 text-center gap-3">
        ...
        <Link to="/register" className="btn btn-primary self-center mt-1">{t('b2b.ctaRegister')}</Link>
      </section>
    </div>
  );
}
